...
def subtitle_finder(user_input='', load_new_data_to_model=True):
    ...
    extracted_subtitle = db.similarity_search_with_relevance_scores(user_input, k=3)
    result = format_output(extracted_subtitle)
    return result